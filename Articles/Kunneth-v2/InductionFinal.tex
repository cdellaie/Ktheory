...
%5\[\sum_U (\phi_U.f\otimes \xi) \Psi_U(a) .  \]
%over the $H$-action.\\
...
\begin{dem} We will show that the inverse map is given by induction. It is clear that induction followed by restriction is the identity.\\ 
...
\begin{dem} The following argument is an adaptation of lemmas $2.41$ and $2.42$ of \cite{TuNonHaus}.\\% I owe to Christian Bönicke the knowledge of these results.\\ 
