...
If $A$ is not unital, let $\tilde A$ be the smallest unitalization of $A$, and $\rho_A: \tilde A \rightarrow \C; (a,\lambda)\mapsto \lambda$ the augmantation map. Then $K_0^{\varepsilon,E}(A)$ is defined as
