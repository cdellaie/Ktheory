...
\begin{Expl}
The standard Hilbert $A$-module satisfies $H_A \cong H\otimes A$, which can be used to prove that $\mathfrak K_A(H_A) \cong A\otimes \mathfrak K$.
\end{Expl}
