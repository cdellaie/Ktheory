...
\begin{dem}
Let $z\in KK^G(\tilde A,\tilde B)$ be represented by the $K$-cycle $[H_{\tilde B},\pi,T]$ and let $P=\frac{1+T}{2}$. Recall that $E^{(\pi,T)} = \{(x,P_G\pi_G(x)P_G+y : x\in \tilde A\rtimes_r G,y\in (\tilde B\rtimes_r G)\otimes\mathfrak K\}$.\\
