...
for every $a\in A$. By convention, for every $G$-equivariant Hilbert module $E$ with action $V$, $\mathcal L_B(E)$ will be endowed with a $G$-algebra structure given by $Ad_V(T) = VTV^*$.  
\end{rk}
