...
\item[$\bullet$] December 6, \textit{Laplacians for geometric $C^*$-algebras and $K$-exactness}, conference $C^*$-algebras and $K$-theory, University of Hawaii at Manoa.
...
\item[$\bullet$] \textbf{ Year 2020 :} University of Hawai'i at M\={a}noa.\\
					Spring, Math 649D, Topics class for graduate students: \textit{Large Scale Geometry and Operator Algebras}\\
