...
\textbf{Publication list:} My work is not published yet, and, if desired, I would be happy to provide a preprint version of my results. My first preprint, \textit{Controlled $K$-theory for groupoids and applications to Coarse Geometry}, is available on the arxiv and has been submitted for publication. The second one is currently under writing and is entitled \textit{A K\"{u}nneth formula for \'etale groupoids	}.
