...
\begin{frame}{$K$-théorie contrôllée}
On munit $P_\infty^{\varepsilon, E}(A)$ et $U_\infty^{\varepsilon, E}(A)$ des relations d'équivalence suivantes:
\begin{itemize}
...
et $K_1^{\varepsilon,E}(A)$ is defined as $U_\infty^{\varepsilon,E}(\tilde A)/ \sim_{\varepsilon,E}$.\\
