...
Motivated by characterizations of Fredholm and spectral questions of N-body Hamiltonians, Victor Nistor and Nicolas Prudhon introduced in \cite{} the notion of exhaustivity of a family of $*$-representation of a $C^*$-algebra.
...
It is proven in \cite{RoeWillett} that property Yu's (A) (see \cite{}) is equivalent to $I_G\cong \mathfrak K(l^2X)$. So in that case, we get
\begin{cor}
