...
%%%%%%%%%%%%
$\bullet$ In \cite{WillettYuGromov}, thm 8.3, Willett and Yu constructed a counterexample for the Baum-Connes conjecture \textit{with coefficients}. Let $G$ be a group whose Cayley graph contains an expander $X$. $G$ does not act on $X$, but we can enlarge $X$ and set 
