...
Compact groups, or better: proper groupoids: Green-Julg. \\
Connes-Kasparov: proof by representation theory (Wasserman, etc)\\
Kasparov's Conspectus: towards Higson-Kasparov paper and the proof for Haagerup (J-L. Tu's general version in $KK$-theory, plus the beautiful result that aTmenability implies bootstrap)\\
Ideas from Coarse geometry, and Yu and Roe's work, SkandalisTuYu etc.\\
