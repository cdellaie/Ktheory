...
\item[$\bullet$] \textbf{FDC} $\Z^{(\infty)}$ has FDC and infinite asdim, but is not finitely generated. The following subgroup of $SL(2,\R)$ has FDC, infinite asymptotic dimension and is finitely generated:  
...
\item[$\bullet$] \textbf{Property A} $|\Gamma|$ has property (A) iff $C_u^*(\Gamma)$ is nuclear (Ozawa, but Guentner-Kaminker...). Non-equivariant version of Haagerup's property. All FDC groups have (A).\\
\end{itemize}
